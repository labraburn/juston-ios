...
public extension NSLayoutAnchor {
    /// Create an equal-to constraint between the receiver and the provided layout anchor.
    ///  The constraint is automatically activated.
    ///
    /// If the receiver is an anchor on a `UIView`,
    /// this method disables `translatesAutoresizingMaskIntoConstraints` on that view.
    ///
    /// - Parameters:
    ...
    /// Create a greater-than-or-equal-to constraint between the receiver and the provided layout anchor.
    ///   The constraint is automatically activated.
    ///
    /// If the receiver is an anchor on a `UIView`,
    ///  this method disables `translatesAutoresizingMaskIntoConstraints` on that view.
    ...
    /// Create a less-than-or-equal-to constraint between the receiver and the provided layout anchor.
    ///  The constraint is automatically activated.
    ///
    /// If the receiver is an anchor on a `UIView`,
    /// this method disables `translatesAutoresizingMaskIntoConstraints` on that view.
